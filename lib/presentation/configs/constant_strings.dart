...
import 'package:sajid_ikram/data/model/activity.dart';
import 'package:sajid_ikram/data/model/certificate.dart';
import 'package:sajid_ikram/data/model/experience.dart';
import 'package:sajid_ikram/data/model/project_info.dart';
import 'package:sajid_ikram/data/model/quote.dart';
import 'package:sajid_ikram/data/model/route_model.dart';
import 'package:sajid_ikram/data/model/showcase_project.dart';
import 'package:sajid_ikram/data/model/social_media.dart';
import 'package:sajid_ikram/presentation/configs/configs.dart';
import 'package:sajid_ikram/presentation/route/routes.dart';
...
const String ksAiMlEnthusiast = "Tech Enthusiast";
...
const String ksIntro = """
  Hi, I'm Sajid Ikram!
    ...
    - a Software Engineering student from UWL
    - a gamer
  """;
...
const String ksFreelanceAvailability = "I'm eager to join a new team.";
const String ksContactInfo = "- Contact Info";
const String ksWorkEmail = "sajidmdikram@gmail.com";
const String ksWorkPhone = "+44 7541 903239";
const String ksCreditTo = "- Big Thanks";
const String ksYeLwinOo = "Ye Lwin Oo";
const String ksYeLwinOoGithub = "https://github.com/YeLwinOo-Steve";

const String ksBuildUsing = "Build using ";
const String ksWithMuch = " with much ";
const String ksCC = "©️ 2024 Sajid Ikram";
...
const String ksFacebookLink = 'https://www.facebook.com/profile.php?id=100008341426590';
const String ksGithubLink = 'https://github.com/Sajid-ikram';
const String ksLinkedInLink = 'https://www.linkedin.com/in/sajid-ikram/';
const String ksStackoverflowLink =
    'https://stackoverflow.com/users/14620219/sajid-ikram';
const String ksDiscordLink = 'https://discordapp.com/users/572462279396818954';
